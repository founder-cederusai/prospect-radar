...
// Tell TypeScript that process.env exists (injected by Vite at build time)
declare const process: any;

// Initialize Gemini Client
// We use the define plugin in vite.config.ts to replace process.env.API_KEY with the actual key string
